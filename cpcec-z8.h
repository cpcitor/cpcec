...
INLINE void z80_main(int _t_) // emulate the Z80 for `_t_` clock ticks
{
	...
	do
	{
		...
		if (z80_irq*z80_active) // ignore IRQs when either is zero!
		{
			...
			if (z80_active<0) // NMI?
			{
				Z80_WAIT(7); Z80_STRIDE_X(0x3A); z80_wz=0x66; // NMI timing equals LD A,($NNNN) : 13 T / 4 NOP (see below IM 0 and IM 1)
			...
			switch (op) // consume EI delay
			{
				...
				case 0x10: // DJNZ $RR
					...
					if (--z80_bc.b.h)
					{
						...
						Z80_QUICK_10FE(0XFFFE==z80_wz&&!z80_iff.b.l);
						#endif
						Z80_IORQ_1X_NEXT(5);
				...
				case 0x20: // JR NZ,$RR
					...
					{
						z80_wz=(signed char)Z80_RD_PC; ++z80_pc.w;
						#ifdef Z80_QUICK_XX20FD
						Z80_QUICK_XX20FD(0XFFFD==z80_wz&&!z80_iff.b.l);
						#endif
						Z80_IORQ_1X_NEXT(5);
				...
				case 0xED: // PREFIX: ED SUBSET
					...
					switch (op)
					{
						...
						case 0xA0: // LDI
							...
							break;
						case 0xB0: // LDIR
							#ifdef Z80_QUICK_EDB0
							Z80_QUICK_EDB0(z80_bc.w>256&&!z80_iff.b.l);
							#endif
							Z80_STRIDE_1;
							Z80_LDID2; ++z80_hl.w; ++z80_de.w;
							Z80_IORQ_1X_NEXT(2);
						...
						case 0xA8: // LDD
							...
							break;
						case 0xB8: // LDDR
							#ifdef Z80_QUICK_EDB8
							Z80_QUICK_EDB8(z80_bc.w>256&&!z80_iff.b.l);
							#endif
							Z80_STRIDE_1;
							Z80_LDID2; --z80_hl.w; --z80_de.w;
							Z80_IORQ_1X_NEXT(2);
						...
						case 0xB9: // CPDR
							Z80_CPID2;
							Z80_IORQ_1X_NEXT(5);
							if (op&8) --z80_hl.w,--z80_wz; else ++z80_hl.w,++z80_wz;
