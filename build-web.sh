...
get_emscripten_flags() {
    ...
    echo "-s EXPORTED_RUNTIME_METHODS=['allocateUTF8','UTF8ToString','ccall','cwrap']"
    echo "-s EXPORTED_FUNCTIONS=['_main','_em_load_file','_em_reset','_em_pause','_em_set_speed','_em_is_running','_em_get_status','_malloc','_free']"
    echo "-s MODULARIZE=0"
